...
Original file is located at
    https://colab.research.google.com/drive/1VsCA-NGS1VmSTNQ4blkS81BBLGEvh7Vp
"""
...
answ=model(question="what is education?",context=context)
answ

answ=model(question="what are different forms of education",context=context)
answ
